...
- [[projects/sambalite-nas-download|SambaLite：从 NAS 下载音乐到 FiiO JM21 TF 卡]]：记录 192.168.3.10 NAS、media 账号、NAS/Media/music 路径、FiiO JM21 TF 卡和 SambaLite 首次递归下载的完整配置与维护方法。
